...
import type { ExternalBlob as _ExternalBlob, Sticker as _Sticker, StickerCategory as _StickerCategory, Timestamp as _Timestamp, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addSticker(arg0: string, arg1: StickerCategory, arg2: string, arg3: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getStickerById(arg0: bigint): Promise<Sticker | null> {
        if (this.processError) {
            try {
...
function from_candid_StickerCategory_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StickerCategory): StickerCategory {
    return from_candid_variant_n16(_uploadFile, _downloadFile, value);
}
async function from_candid_Sticker_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Sticker): Promise<Sticker> {
...
async function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Sticker]): Promise<Sticker | null> {
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Art" in value ? StickerCategory.Art : "Tech" in value ? StickerCategory.Tech : "Nature" in value ? StickerCategory.Nature : "Abstract" in value ? StickerCategory.Abstract : "Other" in value ? StickerCategory.Other : value;
}
async function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Sticker>): Promise<Array<Sticker>> {
...
function to_candid_StickerCategory_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: StickerCategory): _StickerCategory {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: StickerCategory): {
    Art: null;
} | {
    Tech: null;
} | {
    ...
    return value == StickerCategory.Art ? {
        Art: null
    } : value == StickerCategory.Tech ? {
        Tech: null
    } : value == StickerCategory.Nature ? {
        Nature: null
    } : value == StickerCategory.Abstract ? {
        Abstract: null
    } : value == StickerCategory.Other ? {
        Other: null
    } : value;
}
