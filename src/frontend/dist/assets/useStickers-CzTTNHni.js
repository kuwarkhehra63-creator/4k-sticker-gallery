...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, i as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, k as RequestStatusResponseStatus, m as UnknownError, n as RequestStatusDoneNoReplyErrorCode, o as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, v as Principal, w as IDL, x as MissingCanisterIdErrorCode, H as HttpAgent, y as encode, Q as QueryResponseStatus, z as UncertifiedRejectErrorCode, A as isV3ResponseBody, D as isV2ResponseBody, F as UncertifiedRejectUpdateErrorCode, G as UnexpectedErrorCode, J as decode, K as Subscribable, N as pendingThenable, O as resolveEnabled, V as shallowEqualObjects, W as resolveStaleTime, X as noop$1, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, a4 as hashKey, a5 as getDefaultState, r as reactExports, a6 as shouldThrowError, a7 as useQueryClient, a8 as useInternetIdentity, a9 as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, aa as Record, ab as Opt, ac as Variant, ad as Vec, ae as Service, af as Func, ag as Nat, ah as Nat8, ai as Text, aj as Bool, ak as Null, al as Int, am as Principal$1, a as cn } from "./index-730L02pa.js";
...
const StickerCategory$1 = Variant({
  "Art": Null,
  "Tech": Null,
  "Nature": Null,
  "Abstract": Null,
...
const Sticker = Record({
  ...
  "name": Text,
  "description": Text,
  "uploaderPrincipal": Principal$1,
  "category": StickerCategory$1,
...
Service({
  ...
  "addSticker": Func(
    [Text, StickerCategory$1, Text, ExternalBlob$1],
    [Nat],
    []
  ),
  "getStickerById": Func([Nat], [Opt(Sticker)], ["query"]),
  "getStickers": Func([], [Vec(Sticker)], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const StickerCategory2 = IDL2.Variant({
    "Art": IDL2.Null,
    "Tech": IDL2.Null,
    "Nature": IDL2.Null,
    "Abstract": IDL2.Null,
  ...
  const Sticker2 = IDL2.Record({
    "id": IDL2.Nat,
    "blob": ExternalBlob2,
    "name": IDL2.Text,
    "description": IDL2.Text,
    "uploaderPrincipal": IDL2.Principal,
    "category": StickerCategory2,
  ...
  return IDL2.Service({
    ...
    "addSticker": IDL2.Func(
      [IDL2.Text, StickerCategory2, IDL2.Text, ExternalBlob2],
      [IDL2.Nat],
      []
    ),
    "getStickerById": IDL2.Func([IDL2.Nat], [IDL2.Opt(Sticker2)], ["query"]),
    "getStickers": IDL2.Func([], [IDL2.Vec(Sticker2)], ["query"])
  });
};
...
var StickerCategory = /* @__PURE__ */ ((StickerCategory2) => {
  StickerCategory2["Art"] = "Art";
  StickerCategory2["Tech"] = "Tech";
  StickerCategory2["Nature"] = "Nature";
  StickerCategory2["Abstract"] = "Abstract";
  StickerCategory2["Other"] = "Other";
...
class Backend {
  ...
  async addSticker(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.addSticker(arg0, to_candid_StickerCategory_n8(this._uploadFile, this._downloadFile, arg1), arg2, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg3));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getStickers() {
    if (this.processError) {
      try {
        const result = await this.actor.getStickers();
...
function from_candid_StickerCategory_n15(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n16(_uploadFile, _downloadFile, value);
}
async function from_candid_Sticker_n12(_uploadFile, _downloadFile, value) {
...
async function from_candid_opt_n11(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : await from_candid_Sticker_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n13(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    ...
    category: from_candid_StickerCategory_n15(_uploadFile, _downloadFile, value.category),
...
function from_candid_variant_n16(_uploadFile, _downloadFile, value) {
  return "Art" in value ? "Art" : "Tech" in value ? "Tech" : "Nature" in value ? "Nature" : "Abstract" in value ? "Abstract" : "Other" in value ? "Other" : value;
}
async function from_candid_vec_n17(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x) => await from_candid_Sticker_n12(_uploadFile, _downloadFile, x)));
}
async function to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value) {
  return await _uploadFile(value);
}
function to_candid_StickerCategory_n8(_uploadFile, _downloadFile, value) {
...
const ALL_CATEGORIES = Object.values(StickerCategory);
